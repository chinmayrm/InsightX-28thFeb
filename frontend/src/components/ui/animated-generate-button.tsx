  ...
  return (
    <div className={clsx("relative inline-block", className)} id={id}>
      ...
      >
        ...
        <div className="ui-anim-txt-wrapper relative flex min-w-[8em] items-center text-base font-semibold">
          <div
            className={clsx(
      ...
      <style>{`
        ...
        .ui-anim-btn:active {
          ...
          background: linear-gradient(135deg, #1e4a6f 0%, #1f2937 100%);
        }
